...
/*
var argonTextObject1 = document.createElement('div');
argonTextObject1.style.width = 100;
argonTextObject1.style.height = 100;
argonTextObject1.style.backgroundColor = 'blue';
//argonTextObject.style.backgroundImage = 'url(charm-laulima.png)';
//document.body.appendChild(argonTextObject);
userLocation.add(argonTextObject1);

var argonTextObject = new THREE.CSS3DObject(argonTextObject1);
*/
argonTextObject.position.z = -0.5;
userLocation.add(argonTextObject);


var argonTextMesh = createMesh();
argonTextObject.add(argonTextMesh);
argonTextObject.scale.set(0.001, 0.001, 0.001);
argonTextObject.position.z = -1.50;
console.log('ARGON TEXT OBJECT ' + JSON.stringify(argonTextObject));
/*
